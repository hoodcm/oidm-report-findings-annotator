/**
 * Tailwind config for the one-time precompile (dev-only; the app ships the
 * committed css/tailwind.css, no build step at deploy time).
 *
 * Regenerate after class-usage changes:
 *   npx tailwindcss -i css/tailwind.source.css -o css/tailwind.css --minify
 *
 * The color palette and easing are ported verbatim from the former inline
 * Play-CDN config in index.html.
 */
module.exports = {
